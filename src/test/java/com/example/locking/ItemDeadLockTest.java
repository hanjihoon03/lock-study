    ...
    public void testDeadlock() throws InterruptedException {
        ...
        Thread thread1 = new Thread(() -> {
            try {
                ...
                itemService.updateItemsQuantity(item1.getId(), item2.getId(), 4000);
        ...
        Thread thread2 = new Thread(() -> {
            try {
                ...
                itemService.updateItemsQuantity(item2.getId(), item1.getId(), 4000);
        ...
        Item findItem1 = itemRepository.findById(item1.getId()).orElseThrow();
        logger.info(String.valueOf(findItem1.getQuantity()));
        Item findItem2 = itemRepository.findById(item2.getId()).orElseThrow();
        logger.info(String.valueOf(findItem2.getQuantity()));
